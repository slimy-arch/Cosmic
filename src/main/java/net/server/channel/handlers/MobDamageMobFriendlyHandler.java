...
public final class MobDamageMobFriendlyHandler extends AbstractPacketHandler {
    ...
    public final void handlePacket(InPacket p, Client c) {
        ...
        int damage = Randomizer.nextInt(Monster.clampToInt((monster.getMaxHp() / 13 + monster.getPADamage() * 10L) * 2 + 500)) / 10; // Formula planned by Beng.
        ...
        int remainingHp = Monster.clampToInt(monster.getHp());
        if (remainingHp <= 0) {
            remainingHp = 0;
